...
jQuery.fn.oiplayer = function(settings) {
    alet('oi');
    var config = {
        server : 'http://us.local.thegreatcourses.com', /* msie (or java) has issues with just a dir */
        jar : '/skin/frontend/enterprise/tgc/js/cortado-ovt-stripped-0.6.0.jar',
        flash : '/skin/frontend/enterprise/tgc/js/flowplayer-3.2.7.swf',
        controls : 'top'
    };
