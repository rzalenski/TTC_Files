 ...
 */
class Tgc_Boutique_Adminhtml_MultiProductsController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function chooserAction()
    {
        ...
        $productsGrid = $this->getLayout()->createBlock('tgc_boutique/adminhtml_catalog_product_widget_chooser', '', array(
            'id'                => $uniqId,
