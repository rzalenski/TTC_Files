 ...
 */
class Tgc_Boutique_Block_Adminhtml_Catalog_Product_Widget_Chooser extends Mage_Adminhtml_Block_Catalog_Product_Widget_Chooser
{
    ...
    protected function _prepareLayout()
    {
        ...
        return Mage_Adminhtml_Block_Widget_Grid::_prepareLayout();
    }
    ...
    public function getAdditionalJavascript()
    {
        $chooserJsObject = $this->getId();
        $js = '
            $$("#' . $chooserJsObject . '_table thead input:checkbox").invoke("observe", "change", function(event){
