 ...
 */
class Tgc_Boutique_Block_Adminhtml_Catalog_Category_Widget_Chooser extends Mage_Adminhtml_Block_Catalog_Category_Widget_Chooser
{
    ...
    {
        $item = Mage_Adminhtml_Block_Catalog_Category_Tree::_getNodeJson($node, $level);
    ...
    {
        return Mage_Adminhtml_Block_Catalog_Category_Tree::getCategoryCollection()->addAttributeToSelect('url_key')->addAttributeToSelect('is_anchor');
    }
