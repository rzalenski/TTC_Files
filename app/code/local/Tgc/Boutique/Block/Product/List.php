 ...
 */
class Tgc_Boutique_Block_Product_List extends Tgc_Boutique_Block_Product_Abstract
{
    ...
    protected function _construct()
    {
        ...
        if (empty($this->_template)) {
            $this->setTemplate('boutique/widget/list.phtml');
        }
    ...
    public function getCacheKeyInfo()
    {
        return array(
            ...
            'mode' => $this->getToolbarBlock()->getCurrentMode(),
            'order' => $this->getToolbarBlock()->getCurrentOrder(),
            'dir' => $this->getToolbarBlock()->getCurrentDirection()
        );
    }
}
