...
class Tgc_Dax_Model_Import_Entity_Checksum_Enterprise_Product extends Enterprise_ImportExport_Model_Import_Entity_Product
        ...
        while ($source->valid() || $bunchRows) {
            ...
            if ($source->valid()) {
                ...
                if(0 === $source->key()) { //only executes for checksum row
                    ...
                    $rowData = $this->_prepareRowForDbCustom($rowData, $source->key());
