...
class Tgc_Wishlist_Block_Catalog_Product_Price extends Ayasoftware_SimpleProductPricing_Catalog_Block_Product_Price
{
    public function _toHtml()
    {
        if ($this->getTemplate() == 'catalog/product/price.phtml') {
            ...
            if (is_object($product) && $product->getTypeId() == 'configurable') {                /* @var $priceCalc Tgc_Price_Helper_Calc */
                ...
                $extraHtml .= '</span></span>';
                return $start . $extraHtml . $htmlToInsertbefore . Mage_Catalog_Block_Product_Price::_toHtml();
            }
        }
