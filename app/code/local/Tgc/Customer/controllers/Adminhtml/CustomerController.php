...
class Tgc_Customer_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    /**
        ...
        if(!is_array($customersIds)) {
            ...
            try {
                foreach ($customersIds as $customerId) {
                    ...
                    $customer->setNumFailures(null);
                    $customer->save();
                }
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('adminhtml')->__('Total of %d customer(s) were unlocked.', count($customersIds))
                );
            } catch (Exception $e) {
