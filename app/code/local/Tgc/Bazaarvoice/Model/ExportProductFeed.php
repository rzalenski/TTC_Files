 ...
 */
class Tgc_Bazaarvoice_Model_ExportProductFeed extends Bazaarvoice_Connector_Model_ExportProductFeed
{
    ...
    private function writeCategory(Varien_Io_File $ioObject, Mage_Catalog_Model_Category $categoryDefault, array $categoriesByLocale)
    {
        ...
        $categoryPageUrl = htmlspecialchars($categoryDefault->getUrl(), ENT_QUOTES, 'UTF-8');
                                  ...
                                  array $productsByLocale)
    {
        ...
        try {
            $imageUrl = Mage::helper('catalog/image')->init($productDefault, 'image');
            if (strlen($imageUrl)) {
