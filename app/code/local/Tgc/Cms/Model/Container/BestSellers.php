 ...
 */
class Tgc_Cms_Model_Container_BestSellers
    extends Enterprise_PageCache_Model_Container_Abstract
{
    ...
    protected function _getIdentifier()
    {
        ...
        $identifier = $value . '_' . intval($this->_getCookieValue(Tgc_CookieNinja_Model_Ninja::COOKIE_IS_PROSPECT, 0)) . '_'
            ...
            . $this->_getCookieValue(Tgc_CookieNinja_Model_Ninja::COOKIE_AD_CODE, '');
    ...
    protected function _getCacheId()
    {
        ...
        $identifier = 'BESTSELLERS_WIDGET_' . md5($cacheId . $this->_getIdentifier());
