 ...
 */
class Tgc_Cms_Block_Adminhtml_HeroCarousel_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();

        $this->setId('heroCarouselGrid');
    ...
    {
        /** @var $collection Tgc_Cms_Model_Resource_HeroCarousel_Collection */
        $collection = Mage::getModel('tgc_cms/heroCarousel')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('tab_description', array(
            'header'    => Mage::helper('tgc_cms')->__('Tab Description'),
            'align'     => 'left',
            'width'     => '100px',
            'index'     => 'tab_description',
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('heroCarousel');
