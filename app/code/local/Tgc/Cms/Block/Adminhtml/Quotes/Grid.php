 ...
 */
class Tgc_Cms_Block_Adminhtml_Quotes_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        /** @var $collection Tgc_Cms_Model_Resource_Quotes_Collection */
        $collection = Mage::getModel('tgc_cms/quotes')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('quote', array(
            'header'    => Mage::helper('tgc_cms')->__('Quote'),
            'align'     => 'left',
            'width'     => '100px',
            'index'     => 'quote',
        ));
        ...
        $this->addColumn('source', array(
            'header'    => Mage::helper('tgc_cms')->__('Source'),
            'align'     => 'left',
            'width'     => '50px',
            'index'     => 'source',
        ));

        $this->addColumn('additional', array(
            'header'    => Mage::helper('tgc_cms')->__('Additional'),
            'align'     => 'left',
            'width'     => '50px',
            'index'     => 'additional',
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            ...
            'confirm' => Mage::helper('tgc_cms')->__('Really delete the selected quotes item(s)?')
        ));
