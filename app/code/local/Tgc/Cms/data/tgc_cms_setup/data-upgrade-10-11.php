...
$content = <<<CONTENT
{{widget type="tgc_datamart/product_widget_slider" title="Just For You" products_count="30" display_type="user"}}
{{widget type="tgc_cms/newProducts" title="New Releases" display_type="1" products_count="30"}}
{{widget type="tgc_cms/recentlyShopped" title="Recently Shopped" display_type="1" products_count="30" min_products_count="4"}}
CONTENT;
...
$widgets = array(
    ...
    2 => array(
        ...
        'title' => 'Homepage Categories (Guests and Prospects only)',
        'sort_order' => 20,
        'widget_parameters' => array (
            'display_type' => '0',
            'title' => 'Categories',
    ...
    3 => array(
        ...
        'title' => 'Partners (Guests and Prospects only)',
        'sort_order' => 30,
        'widget_parameters' => array (
            'display_type' => '0',
    ...
    4 => array(
        'type' => 'tgc_cms/quotes',
        'title' => 'Quotes (Guests and Prospects only)',
        'sort_order' => 40,
        'widget_parameters' => array (
            'display_type' => '0',
    ...
    5 => array(
        ...
        'title' => 'Bestsellers (Guests and Prospects only)',
        'sort_order' => 50,
        'widget_parameters' => array (
            'display_type' => '0',
            'title' => 'Best Sellers',
