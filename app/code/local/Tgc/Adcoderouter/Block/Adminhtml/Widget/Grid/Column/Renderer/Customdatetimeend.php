<?php
class Tgc_Adcoderouter_Block_Adminhtml_Widget_Grid_Column_Renderer_Customdatetimeend extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Datetime
{
    const DATE_EMPTY = '0000-00-00';
    const NO_DATE_TEXT = 'No End Date';
