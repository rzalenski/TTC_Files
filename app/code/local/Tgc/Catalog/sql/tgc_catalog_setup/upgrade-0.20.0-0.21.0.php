...
$attributeName = "has_admin_changed";

$installer->removeAttribute(Mage_Catalog_Model_Product::ENTITY, $attributeName);
...
$this->addAttribute($entity, $attributeName, $hasAdminChanged);

$eavAttributeConfig = Mage::getModel('eav/config');
$attribute = $eavAttributeConfig->getAttribute(Mage_Catalog_Model_Product::ENTITY, $attributeName);
