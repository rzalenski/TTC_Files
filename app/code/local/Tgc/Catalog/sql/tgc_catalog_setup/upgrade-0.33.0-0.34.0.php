...
$this->addAttribute($entity, 'attribute_set_defined', $attribute_set_defined);
$attrCodes[] = 'attribute_set_defined';

foreach ($attrCodes as $code) {
    $attr = $installer->getAttribute($entity, $code);
    $installer->updateAttribute($entity,$attr['attribute_id'],$attribute_set_defined);
