...
//The set_members attribute was deleted, then it was decided we needed it,  the code below adds the primarySubject field back.
...
$this->addAttribute($entity, 'set_members', $setMembers);
$attrCodes[] = 'set_members';
