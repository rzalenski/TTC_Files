<?php
class FME_Events_Block_Adminhtml_Events_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return Mage::registry('current_events_products');
    }
    /**
     * Add filter
     *
    ...
    {
        $products = $this->getEventsProductsRelated();	
        if (!is_array($products)) {
            $products = array_keys($this->getEventsProducts());
        }
        return $products;
    }
     ...
     * @return array
     */
    public function getEventsProducts()
    {
	
		$id = $this->getRequest()->getParam('id');
       	$productsArr = array();
        foreach (Mage::registry('current_events_products')->getEventsRelatedProducts($id) as $products)
		{
