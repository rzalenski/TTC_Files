...
if (@class_exists('XMLWriter')) {
    ...
    class Xtento_ProductExport_Model_Output_Xml_Writer
    {
        public function __construct()
        {
            Mage::throwException(Mage::helper('xtento_productexport')->__('No PHP XMLWriter functions were found. Please have your server administrator enable them for you.'));
        }
    }
}