...
CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_productexport_destination') . "` (
...
CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_productexport_log') . "` (
...
CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_productexport_profile') . "` (
  ...
  `xsl_template` text NOT NULL,
  `test_id` int(11) NOT NULL,
  PRIMARY KEY (`profile_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_productexport_profile_history') . "` (
