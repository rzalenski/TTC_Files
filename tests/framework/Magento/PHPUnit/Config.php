...
class Magento_PHPUnit_Config
{
    ...
    public function getDatabaseDumpPath()
    {
        return $this->getLibBasePath() . DS . '..' . DS .
            'integration' . DS . '_dump' . DS . 'db_dump.sql';
    }

    public function getDatabaseMd5File()
    {
        return $this->getLibBasePath() . DS . '..' . DS .
            'integration' . DS . '_var' . DS . 'database_md5';
    }
}
